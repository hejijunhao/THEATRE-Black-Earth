...
import { truckParts, soldierParts } from './supportModels';
...
export function figure(variant = 0): THREE.BufferGeometry[] {
  return soldierParts(variant);
}
