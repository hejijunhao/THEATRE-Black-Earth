...
function Atmosphere() {
  ...
  return (
    <>
      ...
      <ambientLight intensity={0.46} color="#d2c498" />
      <hemisphereLight args={['#efe4c4', '#8a7c58', env.ambient]} />
      ...
      <directionalLight
        position={[WORLD_W / 2 + 8, 28, WORLD_H / 2 - 40]}
        intensity={0.72}
        color="#e0d4a4"
      />
      <directionalLight
        position={[WORLD_W / 2 - 20, 22, -8]}
        intensity={0.38}
        color="#d8cc98"
      />
      <directionalLight
      ...
      <directionalLight
        position={[WORLD_W / 2 + 16, 12, WORLD_H / 2 + 24]}
        intensity={0.4}
        color="#f0e6c4"
      />
    </>
